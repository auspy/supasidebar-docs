...
| **4. Link opening behavior** | Global setting: saved browser, frontmost, or default. In "saved browser" mode, each link's [Preferred Browser](/features/airTrafficControl#per-link-preferred-browser) is used | Your preference is "saved browser" and this link was saved from Firefox |
