...
| **3. Link opening behavior** | Global setting: saved browser, frontmost, or default | Your preference is "saved browser" and this link was saved from Firefox |
| **4. System default browser** | Whatever macOS is configured to use | Falls back to your default browser |
