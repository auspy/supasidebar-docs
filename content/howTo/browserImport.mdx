...
If Full Disk Access can't be granted (for example on a managed device), SupaSidebar falls back to importing from a Safari HTML bookmarks export. Use **File - Export Bookmarks** in Safari to create the file, then choose **Import from HTML File** in SupaSidebar.
