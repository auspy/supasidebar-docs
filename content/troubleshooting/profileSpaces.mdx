...
If the profile still doesn't appear, see [Missing browser profiles](/troubleshooting/browserProfilesMissing) for a one-line diagnostic that confirms whether the browser or SupaSidebar is dropping the profile.
