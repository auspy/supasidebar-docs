---
title: "Link opens a new tab instead of switching to it"
description: "Fix SupaSidebar opening a new tab instead of switching to an already-open one, covering permissions, tab tracking mode, and URL redirects."
---
