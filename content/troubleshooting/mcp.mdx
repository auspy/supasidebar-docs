---
title: "SupaSidebar MCP troubleshooting"
description: "Fix npx not found, missing tools in Claude Code, connection failures, and spawn errors when setting up the SupaSidebar MCP server."
---
