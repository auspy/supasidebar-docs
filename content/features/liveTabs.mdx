...
| Status | Browsers |
|--------|----------|
| **Fully Supported** | Safari, Chrome, Edge, Brave, Vivaldi, Comet, Orion, Helium, Dia, Firefox (stable, Nightly, Developer Edition), and 13 additional Chromium-based variants |
