...
| Status | Browsers |
|--------|----------|
| **Fully Supported** | Safari, Chrome, Edge, Brave (incl. Brave Origin), Vivaldi, Comet, Orion, Helium, Dia, Norton Private Browser, Firefox (stable, Nightly, Developer Edition), and additional Chromium-based variants |
