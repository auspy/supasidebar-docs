...
- **From the sidebar '+' menu** - Click **+** and choose **Create New Folder**
- **From a link** - Right-click one link and choose **Create Folder from Link**, or select several links and choose **Create Folder from Selected** to move them into a new folder at once

Folders nest as deep as you need. Right-click a folder and choose **Move to Folder** to file it inside another one.
