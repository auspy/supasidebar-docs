...
The folder-preview delay picker in **Preferences - Sidebar** includes an **Off** option that disables hover-triggered previews entirely. Pick it if you only want the folder browser to open on explicit click, with no popover triggered by hover.
