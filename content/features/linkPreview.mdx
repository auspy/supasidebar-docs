...
The tooltip delay picker in **Preferences - Sidebar** includes an **Off** option that disables hover previews entirely. Pick it if you only ever want previews to open on explicit `Cmd` click or right-click, with no hover-triggered popovers.
