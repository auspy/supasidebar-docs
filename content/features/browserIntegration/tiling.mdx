...
- **Close the sidebar**  - when the sidebar hides, windows expand to fill the full screen by default. See [Sidebar Panel  - Behavior](/features/sidebar#behavior) for options.
...
- **When Sidebar Hides**  - by default, tiled windows expand to fill the full screen when the sidebar hides. You can change this in **Preferences → General → When Sidebar Hides**. See [Sidebar Panel  - Behavior](/features/sidebar#behavior) for details.
