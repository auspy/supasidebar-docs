...
This is independent of [Link Open Tabs to Space](/features/linkOpenTabs) - turn it on if you just want the right browser raised when you switch, even without per-space tab memory.

## Close and Reopen Tabs Per Space

If you want each space to remember its own tabs and reopen them on return, enable [Link Open Tabs to Space](/features/linkOpenTabs) in **Preferences -> Tabs & History -> Advanced**. The flow works identically for profile-linked and regular spaces, and restores tabs in their original browser and profile.
...
1. Open a space in the sidebar
2. In the **Live Tabs** section, click **Link a browser profile**
3. Select a browser without choosing a specific profile
