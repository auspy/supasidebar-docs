...
MCP (Model Context Protocol) is an open standard that lets AI assistants interact with external tools. SupaSidebar exposes 35 tools via its MCP server, so any compatible AI assistant can read and control your sidebar programmatically.
